...
class TvDetailNotifier extends ChangeNotifier {
  ...
  Future<void> fetchTvShowDetail(int id) async {
    ...
    notifyListeners();
    final detailResult = await tvUseCase.getDetailTvShow(id);
    final recommendationResult = await tvUseCase.getTvShowRecommendations(id);
    detailResult.fold(
      (failure) {
  ...
  Future<void> loadWatchlistStatus(int id) async {
    _isAddedtoWatchlist = await tvUseCase.isAddedToWatchlist(id);
    notifyListeners();
  }
